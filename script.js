...
"Muros de Contención y Cimentación" : [
  ...
  },
  {
    ...
    imagenDescripcion: "Nota: Extraído de ¨Manual de Construcción para maestros de obra¨, Aceros Arequipa, 2022.",
  ...
  },
  {
    ...
    imagenDescripcion: "Proyecto ¨Casa Club Solé¨, 2025. Diego Peralta y Sebastián Toapanta",
...
"Mamposteria y Acabados" : [
  ...
  },
  {
    ...
    imagenDescripcion: "Nota: Extraído de ¨Procesos y Técnicas de Construcción¨, de Solminihac & Thenoux, 2011.",
...
actividadesSelect.addEventListener('change', () => {
  ...
  if (actividad) {
    ...
    if (actividad.imagen && actividad.imagen.trim() !== "") {
        html += `<img src="${actividad.imagen}" class="imagen-actividad" alt="${actividad.nombre}">`;
        if (actividad.imagenDescripcion) {
            html += `<p class="imagen-descripcion">${actividad.imagenDescripcion}</p>`;
        }
    }
